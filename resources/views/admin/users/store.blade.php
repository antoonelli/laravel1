...
<div class="container">
    ...
    <form action="{{route('user.store')}}" method="post">
        ...
        <p class="form-group">  
            ...
            <input type="password" name="password_confirmation" id="password-confirm" value="{{old('password_confirmation')}}" class="form-control @if($errors->has('confirm_password')) is-invalid @endif">
